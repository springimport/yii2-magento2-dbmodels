...
class CataloginventoryStockItem extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['product_id', 'stock_id', 'use_config_min_qty', 'is_qty_decimal', 'backorders',
                    'use_config_backorders', 'use_config_min_sale_qty', 'use_config_max_sale_qty',
                    'is_in_stock', 'use_config_notify_stock_qty', 'manage_stock',
                    ...
                    'website_id'], 'integer'],
            [['qty', 'min_qty', 'min_sale_qty', 'max_sale_qty', 'notify_stock_qty',
                    'qty_increments'], 'number'],
            [['low_stock_date'], 'safe'],
            [['product_id', 'website_id'], 'unique', 'targetAttribute' => ['product_id',
                    'website_id'], 'message' => 'The combination of Product Id and Is Divided into Multiple Boxes for Shipping has already been taken.'],
            [['product_id'], 'exist', 'skipOnError' => true, 'targetClass' => CatalogProductEntity::className(),
                'targetAttribute' => ['product_id' => 'entity_id']],
            [['stock_id'], 'exist', 'skipOnError' => true, 'targetClass' => CataloginventoryStock::className(),
                'targetAttribute' => ['stock_id' => 'stock_id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'use_config_notify_stock_qty' => Yii::t('magento2-dbmodels',
            'Use Config Notify Stock Qty'),
            'manage_stock' => Yii::t('magento2-dbmodels', 'Manage Stock'),
            'use_config_manage_stock' => Yii::t('magento2-dbmodels',
            'Use Config Manage Stock'),
            'stock_status_changed_auto' => Yii::t('magento2-dbmodels',
            'Stock Status Changed Automatically'),
            'use_config_qty_increments' => Yii::t('magento2-dbmodels',
            'Use Config Qty Increments'),
            'qty_increments' => Yii::t('magento2-dbmodels', 'Qty Increments'),
            'use_config_enable_qty_inc' => Yii::t('magento2-dbmodels',
            'Use Config Enable Qty Increments'),
            'enable_qty_increments' => Yii::t('magento2-dbmodels',
            'Enable Qty Increments'),
            'is_decimal_divided' => Yii::t('magento2-dbmodels',
            'Is Divided into Multiple Boxes for Shipping'),
            'website_id' => Yii::t('magento2-dbmodels',
            'Is Divided into Multiple Boxes for Shipping'),
        ];
    }
    ...
    {
        return $this->hasOne(CatalogProductEntity::className(),
    ...
    {
        return $this->hasOne(CataloginventoryStock::className(),
        ['stock_id' => 'stock_id']);
    }
}
