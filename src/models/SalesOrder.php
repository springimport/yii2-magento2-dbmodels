...
class SalesOrder extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['is_virtual', 'store_id', 'customer_id', 'can_ship_partially', 'can_ship_partially_item',
                    'customer_is_guest', 'customer_note_notify', 'billing_address_id',
                    'customer_group_id', 'edit_increment', 'email_sent', 'send_email',
                    'forced_shipment_with_invoice', 'payment_auth_expiration', 'quote_address_id',
                    'quote_id', 'shipping_address_id', 'total_item_count', 'customer_gender',
                    'gift_message_id', 'paypal_ipn_customer_notified'], 'integer'],
            [['base_discount_amount', 'base_discount_canceled', 'base_discount_invoiced',
                    ...
                    'base_shipping_tax_amount', 'base_shipping_tax_refunded', 'base_subtotal',
                    'base_subtotal_canceled', 'base_subtotal_invoiced', 'base_subtotal_refunded',
                    'base_tax_amount', 'base_tax_canceled', 'base_tax_invoiced',
                    'base_tax_refunded', 'base_to_global_rate', 'base_to_order_rate',
                    ...
                    'discount_amount', 'discount_canceled', 'discount_invoiced',
                    'discount_refunded', 'grand_total', 'shipping_amount', 'shipping_canceled',
                    'shipping_invoiced', 'shipping_refunded', 'shipping_tax_amount',
                    'shipping_tax_refunded', 'store_to_base_rate', 'store_to_order_rate',
                    'subtotal', 'subtotal_canceled', 'subtotal_invoiced', 'subtotal_refunded',
                    'tax_amount', 'tax_canceled', 'tax_invoiced', 'tax_refunded',
                    'total_canceled', 'total_invoiced', 'total_offline_refunded',
                    'total_online_refunded', 'total_paid', 'total_qty_ordered', 'total_refunded',
                    'adjustment_negative', 'adjustment_positive', 'base_adjustment_negative',
                    'base_adjustment_positive', 'base_shipping_discount_amount',
                    'base_subtotal_incl_tax', 'base_total_due', 'payment_authorization_amount',
                    'shipping_discount_amount', 'subtotal_incl_tax', 'total_due',
                    'weight', 'discount_tax_compensation_amount', 'base_discount_tax_compensation_amount',
                    ...
                    'shipping_incl_tax', 'base_shipping_incl_tax'], 'number'],
            [['customer_dob', 'created_at', 'updated_at'], 'safe'],
            [['customer_note'], 'string'],
            [['state', 'status', 'increment_id', 'customer_prefix', 'customer_suffix',
                    'customer_taxvat', 'ext_customer_id', 'ext_order_id', 'hold_before_state',
                    'hold_before_status', 'original_increment_id', 'relation_child_id',
                    'relation_child_real_id', 'relation_parent_id', 'relation_parent_real_id',
                    'remote_ip', 'shipping_method', 'store_name', 'x_forwarded_for'],
                'string', 'max' => 32],
            [['coupon_code', 'protect_code', 'shipping_description', 'discount_description',
                    'coupon_rule_name'], 'string', 'max' => 255],
            [['applied_rule_ids', 'customer_email', 'customer_firstname', 'customer_lastname',
                    'customer_middlename'], 'string', 'max' => 128],
            [['base_currency_code', 'global_currency_code', 'order_currency_code',
                    'store_currency_code'], 'string', 'max' => 3],
            [['increment_id', 'store_id'], 'unique', 'targetAttribute' => ['increment_id',
                    'store_id'], 'message' => 'The combination of Store Id and Increment Id has already been taken.'],
            [['customer_id'], 'exist', 'skipOnError' => true, 'targetClass' => CustomerEntity::className(),
                'targetAttribute' => ['customer_id' => 'entity_id']],
            [['store_id'], 'exist', 'skipOnError' => true, 'targetClass' => Store::className(),
                'targetAttribute' => ['store_id' => 'store_id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'shipping_description' => Yii::t('magento2-dbmodels',
            ...
            'base_discount_amount' => Yii::t('magento2-dbmodels',
            'Base Discount Amount'),
            'base_discount_canceled' => Yii::t('magento2-dbmodels',
            'Base Discount Canceled'),
            'base_discount_invoiced' => Yii::t('magento2-dbmodels',
            'Base Discount Invoiced'),
            'base_discount_refunded' => Yii::t('magento2-dbmodels',
            'Base Discount Refunded'),
            'base_grand_total' => Yii::t('magento2-dbmodels', 'Base Grand Total'),
            'base_shipping_amount' => Yii::t('magento2-dbmodels',
            'Base Shipping Amount'),
            'base_shipping_canceled' => Yii::t('magento2-dbmodels',
            'Base Shipping Canceled'),
            'base_shipping_invoiced' => Yii::t('magento2-dbmodels',
            'Base Shipping Invoiced'),
            'base_shipping_refunded' => Yii::t('magento2-dbmodels',
            'Base Shipping Refunded'),
            'base_shipping_tax_amount' => Yii::t('magento2-dbmodels',
            'Base Shipping Tax Amount'),
            'base_shipping_tax_refunded' => Yii::t('magento2-dbmodels',
            'Base Shipping Tax Refunded'),
            'base_subtotal' => Yii::t('magento2-dbmodels', 'Base Subtotal'),
            'base_subtotal_canceled' => Yii::t('magento2-dbmodels',
            'Base Subtotal Canceled'),
            'base_subtotal_invoiced' => Yii::t('magento2-dbmodels',
            'Base Subtotal Invoiced'),
            'base_subtotal_refunded' => Yii::t('magento2-dbmodels',
            'Base Subtotal Refunded'),
            'base_tax_amount' => Yii::t('magento2-dbmodels', 'Base Tax Amount'),
            'base_tax_canceled' => Yii::t('magento2-dbmodels',
            'Base Tax Canceled'),
            'base_tax_invoiced' => Yii::t('magento2-dbmodels',
            'Base Tax Invoiced'),
            'base_tax_refunded' => Yii::t('magento2-dbmodels',
            'Base Tax Refunded'),
            'base_to_global_rate' => Yii::t('magento2-dbmodels',
            'Base To Global Rate'),
            'base_to_order_rate' => Yii::t('magento2-dbmodels',
            'Base To Order Rate'),
            'base_total_canceled' => Yii::t('magento2-dbmodels',
            'Base Total Canceled'),
            'base_total_invoiced' => Yii::t('magento2-dbmodels',
            'Base Total Invoiced'),
            'base_total_invoiced_cost' => Yii::t('magento2-dbmodels',
            'Base Total Invoiced Cost'),
            'base_total_offline_refunded' => Yii::t('magento2-dbmodels',
            'Base Total Offline Refunded'),
            'base_total_online_refunded' => Yii::t('magento2-dbmodels',
            'Base Total Online Refunded'),
            'base_total_paid' => Yii::t('magento2-dbmodels', 'Base Total Paid'),
            'base_total_qty_ordered' => Yii::t('magento2-dbmodels',
            'Base Total Qty Ordered'),
            'base_total_refunded' => Yii::t('magento2-dbmodels',
            'Base Total Refunded'),
            'discount_amount' => Yii::t('magento2-dbmodels', 'Discount Amount'),
            'discount_canceled' => Yii::t('magento2-dbmodels',
            'Discount Canceled'),
            'discount_invoiced' => Yii::t('magento2-dbmodels',
            'Discount Invoiced'),
            'discount_refunded' => Yii::t('magento2-dbmodels',
            'Discount Refunded'),
            'grand_total' => Yii::t('magento2-dbmodels', 'Grand Total'),
            'shipping_amount' => Yii::t('magento2-dbmodels', 'Shipping Amount'),
            'shipping_canceled' => Yii::t('magento2-dbmodels',
            'Shipping Canceled'),
            'shipping_invoiced' => Yii::t('magento2-dbmodels',
            'Shipping Invoiced'),
            'shipping_refunded' => Yii::t('magento2-dbmodels',
            'Shipping Refunded'),
            'shipping_tax_amount' => Yii::t('magento2-dbmodels',
            'Shipping Tax Amount'),
            'shipping_tax_refunded' => Yii::t('magento2-dbmodels',
            'Shipping Tax Refunded'),
            'store_to_base_rate' => Yii::t('magento2-dbmodels',
            'Store To Base Rate'),
            'store_to_order_rate' => Yii::t('magento2-dbmodels',
            'Store To Order Rate'),
            'subtotal' => Yii::t('magento2-dbmodels', 'Subtotal'),
            'subtotal_canceled' => Yii::t('magento2-dbmodels',
            'Subtotal Canceled'),
            'subtotal_invoiced' => Yii::t('magento2-dbmodels',
            'Subtotal Invoiced'),
            'subtotal_refunded' => Yii::t('magento2-dbmodels',
            'Subtotal Refunded'),
            ...
            'total_offline_refunded' => Yii::t('magento2-dbmodels',
            'Total Offline Refunded'),
            'total_online_refunded' => Yii::t('magento2-dbmodels',
            'Total Online Refunded'),
            'total_paid' => Yii::t('magento2-dbmodels', 'Total Paid'),
            'total_qty_ordered' => Yii::t('magento2-dbmodels',
            'Total Qty Ordered'),
            'total_refunded' => Yii::t('magento2-dbmodels', 'Total Refunded'),
            'can_ship_partially' => Yii::t('magento2-dbmodels',
            'Can Ship Partially'),
            'can_ship_partially_item' => Yii::t('magento2-dbmodels',
            'Can Ship Partially Item'),
            'customer_is_guest' => Yii::t('magento2-dbmodels',
            'Customer Is Guest'),
            'customer_note_notify' => Yii::t('magento2-dbmodels',
            'Customer Note Notify'),
            'billing_address_id' => Yii::t('magento2-dbmodels',
            'Billing Address Id'),
            'customer_group_id' => Yii::t('magento2-dbmodels',
            'Customer Group Id'),
            ...
            'forced_shipment_with_invoice' => Yii::t('magento2-dbmodels',
            'Forced Do Shipment With Invoice'),
            'payment_auth_expiration' => Yii::t('magento2-dbmodels',
            ...
            'shipping_address_id' => Yii::t('magento2-dbmodels',
            'Shipping Address Id'),
            'adjustment_negative' => Yii::t('magento2-dbmodels',
            'Adjustment Negative'),
            'adjustment_positive' => Yii::t('magento2-dbmodels',
            'Adjustment Positive'),
            'base_adjustment_negative' => Yii::t('magento2-dbmodels',
            'Base Adjustment Negative'),
            'base_adjustment_positive' => Yii::t('magento2-dbmodels',
            'Base Adjustment Positive'),
            'base_shipping_discount_amount' => Yii::t('magento2-dbmodels',
            'Base Shipping Discount Amount'),
            'base_subtotal_incl_tax' => Yii::t('magento2-dbmodels',
            'Base Subtotal Incl Tax'),
            'base_total_due' => Yii::t('magento2-dbmodels', 'Base Total Due'),
            'payment_authorization_amount' => Yii::t('magento2-dbmodels',
            'Payment Authorization Amount'),
            'shipping_discount_amount' => Yii::t('magento2-dbmodels',
            'Shipping Discount Amount'),
            'subtotal_incl_tax' => Yii::t('magento2-dbmodels',
            'Subtotal Incl Tax'),
            ...
            'base_currency_code' => Yii::t('magento2-dbmodels',
            'Base Currency Code'),
            'customer_email' => Yii::t('magento2-dbmodels', 'Customer Email'),
            'customer_firstname' => Yii::t('magento2-dbmodels',
            'Customer Firstname'),
            'customer_lastname' => Yii::t('magento2-dbmodels',
            'Customer Lastname'),
            'customer_middlename' => Yii::t('magento2-dbmodels',
            'Customer Middlename'),
            ...
            'discount_description' => Yii::t('magento2-dbmodels',
            'Discount Description'),
            'ext_customer_id' => Yii::t('magento2-dbmodels', 'Ext Customer Id'),
            'ext_order_id' => Yii::t('magento2-dbmodels', 'Ext Order Id'),
            'global_currency_code' => Yii::t('magento2-dbmodels',
            'Global Currency Code'),
            'hold_before_state' => Yii::t('magento2-dbmodels',
            'Hold Before State'),
            'hold_before_status' => Yii::t('magento2-dbmodels',
            'Hold Before Status'),
            'order_currency_code' => Yii::t('magento2-dbmodels',
            'Order Currency Code'),
            'original_increment_id' => Yii::t('magento2-dbmodels',
            'Original Increment Id'),
            'relation_child_id' => Yii::t('magento2-dbmodels',
            'Relation Child Id'),
            'relation_child_real_id' => Yii::t('magento2-dbmodels',
            'Relation Child Real Id'),
            'relation_parent_id' => Yii::t('magento2-dbmodels',
            'Relation Parent Id'),
            'relation_parent_real_id' => Yii::t('magento2-dbmodels',
            ...
            'store_currency_code' => Yii::t('magento2-dbmodels',
            'Store Currency Code'),
            ...
            'discount_tax_compensation_amount' => Yii::t('magento2-dbmodels',
            'Discount Tax Compensation Amount'),
            'base_discount_tax_compensation_amount' => Yii::t('magento2-dbmodels',
            'Base Discount Tax Compensation Amount'),
            'shipping_discount_tax_compensation_amount' => Yii::t('magento2-dbmodels',
            'Shipping Discount Tax Compensation Amount'),
            'base_shipping_discount_tax_compensation_amnt' => Yii::t('magento2-dbmodels',
            'Base Shipping Discount Tax Compensation Amount'),
            'discount_tax_compensation_invoiced' => Yii::t('magento2-dbmodels',
            'Discount Tax Compensation Invoiced'),
            'base_discount_tax_compensation_invoiced' => Yii::t('magento2-dbmodels',
            'Base Discount Tax Compensation Invoiced'),
            'discount_tax_compensation_refunded' => Yii::t('magento2-dbmodels',
            'Discount Tax Compensation Refunded'),
            'base_discount_tax_compensation_refunded' => Yii::t('magento2-dbmodels',
            'Base Discount Tax Compensation Refunded'),
            'shipping_incl_tax' => Yii::t('magento2-dbmodels',
            'Shipping Incl Tax'),
            'base_shipping_incl_tax' => Yii::t('magento2-dbmodels',
            'Base Shipping Incl Tax'),
            'coupon_rule_name' => Yii::t('magento2-dbmodels',
            'Coupon Sales Rule Name'),
            'gift_message_id' => Yii::t('magento2-dbmodels', 'Gift Message Id'),
            'paypal_ipn_customer_notified' => Yii::t('magento2-dbmodels',
    ...
    {
        return $this->hasMany(DownloadableLinkPurchased::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(PaypalBillingAgreementOrder::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(PaypalBillingAgreement::className(),
        ['agreement_id' => 'agreement_id'])->viaTable('{{%paypal_billing_agreement_order}}',
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesCreditmemo::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesInvoice::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesOrderAddress::className(),
        ['parent_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesOrderItem::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesOrderPayment::className(),
        ['parent_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesOrderStatusHistory::className(),
        ['parent_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesPaymentTransaction::className(),
        ['order_id' => 'entity_id']);
    }
    ...
    {
        return $this->hasMany(SalesShipment::className(),
        ['order_id' => 'entity_id']);
    }
}
